...
input_path = '/home/weiwentao/public-2/data/ninapro-db1'
...
output_path = ('/home/weiwentao/public-2/wwt/ninapro-feature/ninapro-db1-var-raw-prepro-%s-win-%d-stride-%d' % (filtering_type, window, stride))
