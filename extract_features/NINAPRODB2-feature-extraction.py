...
input_path = '/home/daiqingfeng/10.214.150.99/semg/data/ninapro-db2-var-raw'
...
output_path = ('/home/daiqingfeng/10.214.150.99/semg/wwt/ninapro-feature/ninapro-db2-downsample20-var-raw-prepro-%s-win-%d-stride-%d' % (filtering_type, window, stride))
...
#feature_list = ['sampen', 'cc', 'hht58', 'arr29', 'mnf', 'cwt']
#feature_list = ['sampen']
#feature_list = ['cc']
feature_list = ['hht58', 'arr29', 'mnf']
