...
input_path = os.path.join(home, '10.214.150.99/semg/wwt/ninapro-db5')
...
window = window_length_ms*200/1000
stride = window_stride_ms*200/1000

output_path = os.path.join(home, '10.214.150.99/semg/wwt/ninapro-feature/ninapro-db5-var-raw-flip-prepro-%s-win-%d-stride-%d' % (filtering_type, window, stride))
