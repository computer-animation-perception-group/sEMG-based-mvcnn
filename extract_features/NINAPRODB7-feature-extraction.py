...
input_path = os.path.join(home, '10.214.150.99/semg/dqf/data/ninapro-db7/semg/data')
...
output_path = os.path.join(home, '10.214.150.99/semg/dqf/data/ninapro-db7/feature/ninapro-db7-var-raw-downsample20-prepro-%s-win-%d-stride-%d' % (filtering_type, window, stride))
