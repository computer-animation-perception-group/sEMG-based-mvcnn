...
input_path = '/code/dqf/data/ninapro-db6/data'
...
output_path = ('/code/dqf/data/ninapro-feature/ninapro-db6-downsample4-var-raw-prepro-%s-win-%d-stride-%d' % (filtering_type, window, stride))
