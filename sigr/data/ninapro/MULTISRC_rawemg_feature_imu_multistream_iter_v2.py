...
class Feature_RawSEMG_IMU_Multistream_SigImg_Iter_v2(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(Feature_RawSEMG_IMU_Multistream_SigImg_Iter_v2, self).__init__(*args, **kargs)
...
#             print res[0].shape
             ...
             data_1 = temp_data[:, 0:self.channel[0], :]
             data_2 = temp_data[:, self.channel[0]:self.channel[1], :]
             data_3 = temp_data[:, self.channel[1]:self.channel[2], :]
             data_4 = temp_data[:, self.channel[2]:self.channel[3], :]
...
#             print len(self.num_channel)
    ...
    def reset(self):
        self._reset()
        super(Feature_RawSEMG_IMU_Multistream_SigImg_Iter_v2, self).reset()
