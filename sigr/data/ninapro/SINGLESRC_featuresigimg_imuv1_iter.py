"""This file define the data iter of
semg feature signal image with imu activity image"""
...
class FeatureSigImg_ImuData_v1(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(FeatureSigImg_ImuData_v1, self).__init__(*args, **kargs)
        ...
        self.num_channel = self.data[0][1].shape[2] + self.data[1][1].shape[2]
        self.num_channel = int(self.num_channel)
        self.shape1 = len(sigimg_index)-1
        self.shape2 = 1
    ...
    def provide_data(self):
         res = [('data', tuple([self.batch_size, self.num_channel] + list([self.shape1, self.shape2])))]
...
#        res = res.reshape(res.shape[0], 1, res.shape[1], res.shape[2])
    ...
    def _getdata(self, data_source):
        ...
        if data_source is self.data:
             ...
             res = []
             res.append(np.concatenate((semg_res, imu_res), axis=1))
    ...
    def reset(self):
        self._reset()
        super(FeatureSigImg_ImuData_v1, self).reset()
